...
better to switch. 
+ Using a `for` loop based approach is perfectly fine for this type of problem. 
I just wanted a vectorised approach as it was bugging me ;) 
+ R gives users a lot of choices and many users have their preferences hence I to
decided to provide three possible solutions :)
