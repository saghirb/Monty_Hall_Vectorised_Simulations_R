...
> Use a vectorised approach to simulating the probability of winning for both staying with 
...
+ All three simulations lead to the same conclusion -- that it is probabilistically 
better to switch. 
+ I provide three vectorised solutions as the R community is diverse and with different
preferences. 
+ Using a `for` loop based approach is perfectly fine for this problem. I just wanted 
code it using a vectorised approach as it was bugging me ;) 

**Thanks for reading.**

## Acknowledgements

Thank to the [R core](https://www.r-project.org/contributors.html), [`data.table`](https://rdatatable.gitlab.io/data.table/authors.html) and
